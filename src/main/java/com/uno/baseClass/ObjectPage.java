...
public class ObjectPage {
	...
	public SD_HomePage sd_homePage;
	public SD_TicketPage sd_TicketPage;
	public SD_ViewTicketPage sd_ViewTicketPage;
	...
	public RM_LoginPage rm_LoginPage;
	public RM_HomePage rm_HomePage;
	public RM_IncidentPage rm_IncidentPage;
	public RM_EditIncidentPage rm_EditIncidentPage;
	public RM_ViewIncidentPage rm_ViewIncidentPage;
	...
	public Customer_HomePage customer_HomePage;
	public Customer_TicketSummaryPages customer_TicketSummaryPages;
	public Customer_ViewIncidentPage customer_ViewIncidentPage;
	...
	public static WebElement tabHomeInCustomer;
	...
	@FindBy(xpath = "/html[1]/body[1]/div[1]/form[1]/div[1]/div[1]/div[2]/div[1]/div[1]/a[1]")
	public static WebElement tabSearchInCustomer;

	// text box of id
	@FindBy(xpath = ".//*[@id='right']/div[1]/div/table/tbody/tr[2]/td[2]")
	public static WebElement textBoxId;
	
	// text box of Asset Id
	@FindBy(xpath = ".//*[@id='right']/div[1]/div/table/tbody/tr[2]/td[5]")
	public static WebElement textBoxAssetId;
	
	// text box of Ticket ID
	@FindBy(xpath = ".//*[@id='right']/div[1]/div/table/tbody/tr[2]/td[8]")
	public static WebElement textBoxTicketID;
	...
	// Select Id in Table
	@FindBy(xpath = ".//*[@id='right']/div[2]/div/div[1]/div[2]/table/tbody/tr/td[1]/span/a")
	public static WebElement lblIdInTable;
	...
	// list of Blinking Notification in View Ticket Table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(1)>span>i")
	public static List<WebElement> lstBlinkingNotificationInTable;
	...
	// Left Most Arrow Of Pagination
	@FindBy(css = "div[id='pagination']:nth-of-type(2)>a:nth-of-type(1)")
	public static WebElement arrow_LeftmostArrowOfPagination;
	
	// Left Most Arrow Of Pagination
	@FindBy(css = "a[onclick='callfirst()']")
	public static WebElement arrow_LeftmostArrowOfPaginationInCustomer;

	// Right Most Arrow Of Pagination
	@FindBy(css = "div[id='pagination']:nth-of-type(2)>a:nth-of-type(4)")
	public static WebElement arrow_RightmostArrowOfPagination;
	
	// Right Most Arrow Of Pagination
	@FindBy(css = "a[onclick='calllast()']")
	public static WebElement arrow_RightmostArrowOfPaginationInCustomer;

	// Right Arrow Of Pagination
	@FindBy(css = "div[id='pagination']:nth-of-type(2)>a:nth-of-type(3)")
	public static WebElement arrow_RightArrowOfPagination;
	
	// Right Arrow Of Pagination
	@FindBy(css = "a[onclick='callNext();']")
	public static WebElement arrow_RightArrowOfPaginationInCustomer;

	// Left Arrow Of Pagination
	@FindBy(css = "div[id='pagination']:nth-of-type(2)>a:nth-of-type(2)")
	public static WebElement arrow_LeftArrowOfPagination;
	
	// Left Arrow Of Pagination
	@FindBy(css = "a[onclick='callPrevious();']")
	public static WebElement arrow_LeftArrowOfPaginationInCustomer;

	// Selected Page in Pagination
	@FindBy(css = "div[id='pagination']:nth-of-type(2)>select>option[selected='selected']")
	public static WebElement page_SelectedInPagination;
	
	// Selected Page in Pagination
	@FindBy(css = "select[name='m_strPaginateValue']>option[selected='selected']")
	public static WebElement page_SelectedInPaginationInCustomer;

	// List of Row in Table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr")
	public static List<WebElement> lstRowInTable;
	
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(7)>a")
	public static List<WebElement> lstAssetIdInTable;
	
	// Pagination
		@FindBy(css = "div[id='pagination']:nth-of-type(2)>select>option")
		public static List<WebElement> dropdown_Pagination;
		
		@FindBy(xpath = "//select[@name='m_strPaginateValue']/option")
		public static List<WebElement> dropdown_PaginationInCustomer;
		...
		// List of Row in Table
		@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr")
		public static List<WebElement> list_RowInTable;
	...
	@FindBy(css = "a[onclick='submitValuesIncidentID()']")
	public static WebElement btnGoOfIdInCustomer;
	...
	@FindBy(css = "a[ onclick='submitValuesAssetID()']")
	public static WebElement btnGoOfAssetIdINCustomer;
	...
	@FindBy(css = "a[onclick='submitValuesTicketID()']")
	public static WebElement btnGoOfTicketIdInCustomer;
	
	// List Of Id in Table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr")
	public static List<WebElement> lstRow;
	
	@FindBy(css = "#pagination>strong")
	public static WebElement lblcount;
	
	@FindBy(xpath = "//strong[contains(text(),'Total Ticket Count:')]")
	public static WebElement lblcountInCustomer;
	...
	public static WebElement ddlCTSFilter;
	...
	public static WebElement ddlCreateByRole;

	// select create by filter text box ,with default selected value
	@FindBy(css = "select[name='m_strFilterCreatedBy']")
	public static WebElement ddlCreateBy;

	// select category filter text box ,with default selected value
	@FindBy(css = "select[name='m_strProductCategory']")
	public static WebElement ddlCategory;

	// select sub category filter text box ,with default selected value
	@FindBy(css = "select[name='m_strProductSubCategory']")
	public static WebElement ddlSubCategory;
	...
	public static WebElement ddlAssign;
	...
	@FindBy(xpath = "//div[@class='fht-fixed-column']//tbody//tr//td[1]//div[1]/a")
	public static List<WebElement> lstIDInTableInCustomer;
	
	@FindBy(xpath = "//div[@class='fht-fixed-column']//tbody//tr//td[1]")
	public static List<WebElement> lstIDWthNoteInTableInCustomer;

	// select list of status in table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(8)")
	public static List<WebElement> lstStatusInTable;
	
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(7)")
	public static List<WebElement> lstStatusInTableInCustomer;
	
	// select list of status in table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(11)")
	public static List<WebElement> lstTicketTypeInTable;
	
	// select list of status in table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(22)")
	public static List<WebElement> lstCTSInTable;
	
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(15)")
	public static List<WebElement> lstStateInTable;
	...
	public static List<WebElement> lstCustomerInTableInCustomer;
	
	// select list of status in table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(26)>span")
	public static List<WebElement> lstEngineerInTable;
	
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(18)")
	public static List<WebElement> lstEngineerInTableInCustomer;
	
	// select list of status in table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(52)")
	public static List<WebElement> lstCreatedByRoleInTable;
	
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(52)")
	public static List<WebElement> lstCreatedByRoleInTableInCustomer;
	
	// select list of status in table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(51)")
	public static List<WebElement> lstCreatedByInTable;
	
	// select list of status in table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(62)")
	public static List<WebElement> lstCategoryInTable;	
	
	// select list of status in table
	@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(63)")
	public static List<WebElement> lstSubCategoryInTable;
	...
	@FindBy(linkText = "Ticket")
	public static WebElement tab_Ticket;

	@FindBy(css = "a[href='/erprmwise/IncidentAction.do']")
	public static WebElement tab_CreateNew;

	@FindBy(xpath = "//a[@href='/erprmwise/SearchIncidentPage.do?MenuClick=ViewIncident']")
	public static WebElement tab_ViewTicket;
	...
	// Select Requests Open Tab
		...
		// Select Requests Open Tab
		@FindBy(css = "a[onclick='submitPaused();']")
		public static WebElement tabRequestsPauseInTicketSummary;
		
		@FindBy(css = "a[onclick='submitCancel();']")
		public static WebElement tabRequestsCancelInTicketSummary;

		@FindBy(css = "a[onclick='submitClosed();']")
		public static WebElement tabRequestsCloseInTicketSummary;
		
		@FindBy(css = "a[onclick='submitTechClosed();']")
		public static WebElement tabRequestsClosedByTechnicianInTicketSummary;
		
		@FindBy(css = "a[onclick='submitAll();']")
		public static WebElement tabAllRequestsInTicketSummary;

		
		// Label Ticket Count in Ticket Table
		@FindBy(css = "a[onclick='submitPaused();']>span[class='badge']")
		public static WebElement lblCountOfRequestPauseTab;
		
		@FindBy(css = "a[onclick='submitCancel();']>span[class='badge']")
		public static WebElement lblCountOfRequestCancelTab;
		
		@FindBy(css = "a[onclick='submitClosed();']>span[class='badge']")
		public static WebElement lblCountOfRequestCloseTab;
		
		
		@FindBy(css = "a[onclick='submitAll();']>span[class='badge']")
		public static WebElement lblCountOfAllRequestTab;
		
		@FindBy(css = "a[onclick='submitTechClosed();']>span[class='badge']")
		public static WebElement lblCountOfRequestClosedByTechnicianTab;

		// Label Ticket Count in Ticket Table
		@FindBy(xpath = "//strong[contains(text(),'Total Ticket Count:')]")
		public static WebElement lblTicketCountInTicketTableInCustomer;

		// Status in Ticket Table
		@FindBy(css = "table[class='fht-table fht-table-init']>tbody>tr>td:nth-of-type(7)")
		public static List<WebElement> lstStatusInTicketTableInCustomer;
		
		// Home Tab of Technician
		@FindBy(css = "a[href='/erprmwise/CustomerHomeScreen.do']")
		public static WebElement tabHomeOfCustomer;
